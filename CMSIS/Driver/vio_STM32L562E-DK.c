...
/*! \page vio_STM32L562E-DK Physical I/O Mapping
...
| vioLED0       | vioSignalOut.0 | LED red     (LD9)    | PD3
| vioLED1       | vioSignalOut.1 | LED green   (LD10)   | PG12
*/
...
//  signal,     pin,                   pull resistor,      active state
  { vioLED0,    GPIO_PIN_ID_PORTD(3),  ARM_GPIO_PULL_NONE, VIO_ACTIVE_LOW },
  { vioLED1,    GPIO_PIN_ID_PORTG(12), ARM_GPIO_PULL_NONE, VIO_ACTIVE_LOW }
};
#endif
