...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pins : ARD_D9_Pin ARD_D6_Pin */
  GPIO_InitStruct.Pin = ARD_D9_Pin|ARD_D6_Pin;
  ...
  /*Configure GPIO pins : GYRO_ACC_INT_Pin SDIO_DETECT_Pin ARD_D4_Pin */
  GPIO_InitStruct.Pin = GYRO_ACC_INT_Pin|SDIO_DETECT_Pin|ARD_D4_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /*Configure GPIO pins : ARD_D5_Pin ARD_D2_Pin ARD_D3_Pin */
  GPIO_InitStruct.Pin = ARD_D5_Pin|ARD_D2_Pin|ARD_D3_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  HAL_NVIC_SetPriority(EXTI6_IRQn, 4, 0);
  HAL_NVIC_EnableIRQ(EXTI6_IRQn);

  HAL_NVIC_SetPriority(EXTI8_IRQn, 4, 0);
  HAL_NVIC_EnableIRQ(EXTI8_IRQn);

  HAL_NVIC_SetPriority(EXTI9_IRQn, 4, 0);
  HAL_NVIC_EnableIRQ(EXTI9_IRQn);

  HAL_NVIC_SetPriority(EXTI11_IRQn, 4, 0);
